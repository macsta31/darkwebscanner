...
<div id="wrapper">
  {#if loaded}
    <section
      ...
      transition:fly={{ y: -200, duration: 1000, delay: 0 }}
    >
      <div class="formdiv">
        ...
        {#if !searching}
          <form on:submit|preventDefault={handleSubmit}>
            ...
            {#if $user}
                <label class="checkbox-container">
                Save Results?
                <input type="checkbox" bind:checked={dbSave} />
                <span class="custom-checkbox" />
                </label>
            {/if}
          </form>
      ...
      <div class="custom-shape-divider-bottom-1688128729">
        ...
        >
          ...
          <path
            ...
            opacity=".5"
            class="shape-fill"
            transition:fly={{ y: -200, duration: 2000, delay: 200 }}
          />
          <path
    ...
    {#if promise}
      {#await promise then value}
        <section id="results" style="padding-top: 20rem;">
          ...
          <div>
            <h2
              style="padding-bottom: 2rem; text-align: center; font-size: 1.5rem"
            >
              Scan Results for {searchParam}
            </h2>
          ...
          <footer>
            <a href="https://haveibeenpwned.com"
              >All data provided by Have I Been Pwned</a
            >
          </footer>
        </section>
      {:catch error}
...
<style>
  ...
  button {
    ...
    flex: 1;
    box-shadow: inset 5px 5px 15px rgb(47, 63, 198),
      inset -5px -5px 15px rgb(47, 63, 198);
    width: 50%;
    align-self: center;
  }
  button:hover {
  ...
  button:active {
    ...
    box-shadow: inset 5px 5px 10px rgb(36, 47, 150),
      inset -5px -5px 10px rgb(36, 47, 150);
  }
